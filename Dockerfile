...
RUN chown -R $USERNAME:$USERNAME /media/HDD1/tom/SSM
...
ENV BASE="/media/HDD1/tom/SSM/U-Mamba/data" \
    nnUNet_raw="/media/HDD1/tom/SSM/U-Mamba/data/nnUNet_raw" \
    nnUNet_preprocessed="/media/HDD1/tom/SSM/U-Mamba/data/nnUNet_preprocessed" \
    nnUNet_results="/media/HDD1/tom/SSM/U-Mamba/data/nnUNet_results"

# Copy your application code to the container (ensure your context and paths are set correctly)
COPY . /app
